...
namespace EmpireRuins
{
    public partial class Level1 : Form
    {
        ...
        private void Level1_Load_1(object sender, EventArgs e)
        {
            ...
            //adding GameObjects
            g.addGameObject(EmpireRuins.Properties.Resources.char9, 230, 450, true, ObjectTypes.shootingEnemy,new Horizontal(10, boundary, "Left"));
            g.addGameObject(EmpireRuins.Properties.Resources.char10, 350, 650, false, ObjectTypes.enemy ,new Vertical(10, boundary, "Up"));
        ...
        private void GameTimer1_Tick(object sender, EventArgs e)
        {
            ...
            if (num % 15 == 0)
            {
                ...
                g.addGameObject(EmpireRuins.Properties.Resources.Icon1, (shootingEnemy.Location.Y + (shootingEnemy.Height / 2)), (shootingEnemy.Location.X + (shootingEnemy.Width / 2)), false, ObjectTypes.enemyFire, new Shooting(10, boundary, "Down"));
            }
